...
public class MyBG extends View {
    ...
    //小格子的宽度
    private int smallGrid = 35;
    //大个字的宽度 一个大格子里面包含5个小格子
    private int bigGrid = smallGrid * 4;
    //小格子的线的颜色
    private int smallGridColor = Color.parseColor("#000000");
    //大格子的线的颜色
    private int bigGridColor = Color.parseColor("#000000");
    //View的背景颜色
